  ...
  return (
    <main className="flex min-h-svh flex-col items-center justify-center bg-ink px-6 py-20">
      ...
      <div className="w-full max-w-sm">
        <h1 className="text-center font-display text-2xl font-semibold text-ivory">Admin-Login</h1>
        <p className="mt-2 text-center text-sm text-ivory-dim">Interner Zugang für NoviDom.</p>
